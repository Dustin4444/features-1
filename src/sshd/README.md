...
```json
"features": {
    "ghcr.io/Dustin4444/features-1/sshd:1": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/Dustin4444/features-1/blob/main/src/sshd/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
